...
final dashboardStatsProvider = FutureProvider<DashboardStats>((ref) async {
  ...
  final monthExpenses = await db.getExpensesByDateRange(
    firstDayOfMonth,
    lastDayOfMonth,
  );
                    ...
                    LineChartData(
                      gridData: FlGridData(
                        ...
                        getDrawingHorizontalLine: (value) {
                          return FlLine(color: Colors.grey[80], strokeWidth: 1);
                        },
                      ),
                        ...
                        bottomTitles: AxisTitles(
                          sideTitles: SideTitles(
                            ...
                            getTitlesWidget: (value, meta) {
                              if (value.toInt() >= 0 &&
                                  value.toInt() < monthlyExpenses.length) {
                                final month =
                      ...
                      lineBarsData: [
                        LineChartBarData(
                          ...
                          belowBarData: BarAreaData(
                            show: true,
                            color: Colors.blue.light.withValues(alpha: 0.3),
                          ),
                        ),
                      ],
                        ...
                        touchTooltipData: LineTouchTooltipData(
                          getTooltipItems: (touchedSpots) {
                            return touchedSpots.map((spot) {
                              if (spot.spotIndex >= 0 &&
                                  spot.spotIndex < monthlyExpenses.length) {
                                final monthData =
                                    monthlyExpenses[spot.spotIndex];
